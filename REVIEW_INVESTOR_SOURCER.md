...
| 🔴 3 | Formal offer letter generation | 0.5 day | High |
| 🔴 4 | EPC auto-fetch | 0.5 day | High (mortgage risk flagging) |
| 🟡 5 | Lead notes / memo system | 0.5 day | High (team workflow) |
| 🟡 6 | Refurb line-item breakdown | 1 day | High (investor trust) |
| 🟡 7 | Human AI handover ("Take Over") | 0.5 day | High |
| 🟡 8 | Comp exclude/adjust | 0.5 day | Medium (valuation accuracy) |
| 🟠 9 | Cash vs mortgage toggle | 0.5 day | Medium (investor UX) |
| 🟠 10 | AI-generated deal summary | 0.5 day | Medium (pack quality) |
| 🟠 11 | Flood risk check | 1 day | Medium (deal qualification) |
| 🟠 12 | Floorplan upload | 0.5 day | Medium (pack completeness) |
| 🔵 13 | Deal score badge | 0.5 day | Medium (sourcer efficiency) |
| 🔵 14 | Bulk investor SMS | 0.5 day | Medium |
| 🔵 15 | Duplicate phone/address detection | 0.5 day | Low-Medium |
| 🔵 16 | Post-completion feedback | 1 day | Low (long-term only) |
| 🔵 17 | Auction workflow | 2 days | Low (niche) |
| 🔵 18 | Street view in map modal | 0.5 day | Low |

---

*This document was generated by reviewing all source files, components, API routes, Prisma schema, and project brief on 2026-05-15. Update it as features ship.*
