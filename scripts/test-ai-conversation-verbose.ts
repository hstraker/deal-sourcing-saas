/**
 * Test Script: Simulate AI SMS Conversation (Verbose)
 * 
 * Enhanced version with better error handling and output
 */
  ...
  try {
    ...
    for (let i = 0; i < conversationFlow.length; i++) {
      ...
      try {
        ...
        console.log(`✅ AI processed message ${i + 1}`)
      } catch (error: any) {
    ...
    if (finalLead?.smsMessages && finalLead.smsMessages.length > 0) {
    ...
    console.log(`\n   Click on the lead card to see the full conversation.`)
